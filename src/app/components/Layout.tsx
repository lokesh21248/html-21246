...
export function Layout() {
  ...
  const handleLogout = () => {
    // TODO: Clear Supabase session and redirect to login
        ...
        <div className="p-4 border-t border-white/20">
          <div className="flex items-center gap-3 px-3 py-3 bg-white/10 rounded-xl backdrop-blur-sm">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-white/70 truncate">admin@pgbooking.com</p>
            </div>
          </div>
        </div>
      </aside>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                style={{ color: theme === 'blue' ? '#2563eb' : theme === 'purple' ? '#9333ea' : '#059669' }}
              />
            </div>
          </div>
              ...
              {showThemeMenu && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 z-20">
                    ...
                    >
                      <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg shadow-md"></div>
                      <span className="text-sm font-medium text-gray-700">Ocean Blue</span>
                      {theme === "blue" && <div className="ml-auto w-2 h-2 bg-blue-600 rounded-full"></div>}
                    </button>
                    <button
                      onClick={() => {
                        setTheme("purple");
                      ...
                      className="w-full px-4 py-3 hover:bg-gray-50 flex items-center gap-3 transition-colors"
                    >
                      <div className="w-8 h-8 bg-gradient-to-br from-purple-600 to-purple-800 rounded-lg shadow-md"></div>
                      <span className="text-sm font-medium text-gray-700">Royal Purple</span>
                      {theme === "purple" && <div className="ml-auto w-2 h-2 bg-purple-600 rounded-full"></div>}
                    </button>
                    <button
                      onClick={() => {
                        setTheme("green");
                      ...
                      className="w-full px-4 py-3 hover:bg-gray-50 flex items-center gap-3 transition-colors"
                    >
                      <div className="w-8 h-8 bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-lg shadow-md"></div>
                      <span className="text-sm font-medium text-gray-700">Fresh Green</span>
                      {theme === "green" && <div className="ml-auto w-2 h-2 bg-emerald-600 rounded-full"></div>}
                    </button>
                  </div>
                </>
              )}
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-200 z-20 max-h-96 overflow-y-auto">
                    ...
                    <div className="px-4 py-3 border-t border-gray-200 text-center">
                      <button className={`text-sm font-medium ${colors.primaryText} hover:underline`}>
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 z-20">
                    <div className="px-4 py-3 border-b border-gray-200">
                      ...
                      <p className="text-xs text-gray-500 mt-1">admin@pgbooking.com</p>
                    </div>
                    <button 
                      onClick={() => setShowUserMenu(false)}
